...
const Header = () => {
  ...
  return (
    <header
      ...
      bg-background
      border-b
      w-full mx-auto sm:px-6 lg:px-8 min-w-[300px]"
      style={{
        zIndex: 999,
      }}
    >
      <nav className="relative flex justify-between py-[10px] mx-auto flex max-w-7xl items-center justify-between gap-x-6 p-3 lg:px-8">
